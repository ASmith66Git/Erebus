    ...
    const result = await client.query(
      ...
      [
        ...
        JSON.stringify(dto.samples.map(s => ({
          ...
          gf99_percent: s.metrics?.gf99_percent || null,
          ceiling_meters: s.metrics?.ceiling_meters || null,
          ...
          cns_percent: s.metrics?.cns_percent || null,
          otu: s.metrics?.otu || null,
          tank_pressure_bar: s.metrics?.tank_pressure_bar || null,
          setpoint_bar: s.metrics?.setpoint_bar || null,
        }))),
        JSON.stringify(dto.gases.map(g => ({
          ...
          he: g.he_percent,
          n2: g.n2_percent,
          is_diluent: g.is_diluent,
          is_bailout: g.is_bailout,
          gas_slot: g.gas_slot,
